"use strict";
(self["webpackChunkweatherapp"] = self["webpackChunkweatherapp"] || []).push([["vendors-node_modules_chartjs-plugin-annotation_dist_chartjs-plugin-annotation_esm_js-node_mod-7c1274"],{
...
function updateListeners(chart, state, options) {
  ...
  hooks.forEach(hook => {
    ...
    } else if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.defined)(state.listeners[hook])) {
...
function toPosition(value) {
  if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.isObject)(value)) {
    return {
      x: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(value.x, 'center'),
      y: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(value.y, 'center'),
    };
  }
  value = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(value, 'center');
  return {
    x: value,
    y: value
  };
...
function measureLabelSize(ctx, options) {
  ...
  const font = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.toFont)(options.font);
...
class LabelAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__.Element {
  ...
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    const {x, y} = rotated({x: mouseX, y: mouseY}, this.getCenterPoint(useFinalPosition), (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.toRadians)(-this.rotation));
    return inBoxRange({x, y}, this.getProps(['x', 'y', 'x2', 'y2'], useFinalPosition), axis, this.options.borderWidth);
  }
...
class PointAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__.Element {
  ...
  draw(ctx) {
    ...
    (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.drawPoint)(ctx, options, this.centerX, this.centerY);
...
function getOrCreateElement(elements, index, type, initProperties) {
  ...
  if (!element || !(element instanceof elementClass)) {
    ...
    if ((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.isObject)(initProperties)) {
...
function resolveObj(resolver, defs) {
  ...
  for (const prop of Object.keys(defs)) {
    ...
    result[prop] = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.isObject)(optDefs) ? resolveObj(value, optDefs) : value;
  }
  return result;
}
...
var annotation = {
  ...
  beforeRegister() {
    requireVersion('chart.js', '3.7', chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart.version);
  },
...
//# sourceMappingURL=vendors-node_modules_chartjs-plugin-annotation_dist_chartjs-plugin-annotation_esm_js-node_mod-7c1274.40640506a89bdc2c56c3.js.map