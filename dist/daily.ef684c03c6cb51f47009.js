...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/styles/daily.css":
/*!********************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/styles/daily.css ***!
  \********************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_daily_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./daily.css */ "./node_modules/css-loader/dist/cjs.js!./src/styles/daily.css");
...
chart_js_auto__WEBPACK_IMPORTED_MODULE_3__["default"].defaults.plugins.datalabels.align = 'end';
console.log(chart_js_auto__WEBPACK_IMPORTED_MODULE_3__["default"].defaults)
...
const getWeatherOnCity = (lat, lon, day = getCurrentDate()) => {
    getWeather(lat, lon, day).then((res) => {
        ...
        if (!tempChart) {
          ...
          //   tempChartConfig.options.scales.y.display = false;
          // }
          tempChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_3__["default"](myChart, tempChartConfig);
        } else {
...
;(0,_changeLocation__WEBPACK_IMPORTED_MODULE_2__["default"])(getWeatherOnCity);
