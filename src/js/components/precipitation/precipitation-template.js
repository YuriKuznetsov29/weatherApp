            ...
            return `
                <div class="precipitation__item">
                    ...
                    <svg class="precipitation__quantity-drop" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="40" height="40">
                        ...
                        <path d="M208,144c0-72-80-128-80-128S48,72,48,144a80,80,0,0,0,160,0Z" fill="url(#inside-gradient${i})" stroke="rgba(255, 255, 255, 0.8)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
                    </svg>
